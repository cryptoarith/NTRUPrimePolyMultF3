...
/*************************************************
* Name:         Hybrid-2 Algorithm corresponds to ka2_real() function below. 
...
*              Using a combination of  8 levels of KA2 then 1 level of SB algorithms that are described in the paper: https://eprint.iacr.org/2020/1336.pdf
*
...
/* The Hybrid-2 Algorithm corresponds to ka2_real() function below. See the paper: https://eprint.iacr.org/2020/1336.pdf  for the details*/
...
/*write on c_hybrid_2 file*/	
	FILE *outFile;
    outFile = fopen("c_hybrid_2", "w");
    if (outFile == NULL)
	{
