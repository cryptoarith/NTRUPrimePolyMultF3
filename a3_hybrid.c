...
/*************************************************
* Name:         A3-Hybrid Algorithm corresponds to a3_real() function below. 
...
/* The A3-Hybrid Algorithm corresponds to a3_real() function. See the paper: https://eprint.iacr.org/2020/1336.pdf  for the details*/
...
int main(){
    ...
    fclose(myFile);
	 ...
	 /*write on c_a3_hybrid file*/
	FILE *outFile;
    outFile = fopen("c_a3_hybrid", "w");
    if (outFile == NULL)
	{
