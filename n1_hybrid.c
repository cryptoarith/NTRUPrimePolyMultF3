...
/*************************************************
* Name:         N1-Hybrid Algorithm corresponds to n1_real() function below.
...
/* The N1-Hybrid Algorithm corresponds to n1_real() function. See the paper: https://eprint.iacr.org/2020/1336.pdf  for the details*/
...
int main(){
	...
	/*write on c_n1_hybrid file*/	
	FILE *outFile;
    outFile = fopen("c_n1_hybrid", "w");
    if (outFile == NULL)
	{
