...
/*************************************************
* Name:         N1-Hybrid2 Algorithm corresponds to n1_real() function below.
...
*              Using a combination of  N1, A3, KA2, and SB algorithms that are described in the paper: https://eprint.iacr.org/2020/1336.pdf
*
...
void n1_complex(struct complex a[], struct complex b[], struct complex c[], int n){
	...
	/* base case */
	if(n == 12){   /* N1-Hybrid2 is derived from N1-Hybrid by modifying this base value from n=4 to n=12 */
...
void ka2_real(struct complex a[], struct complex b[], struct complex c[], int n){
	...
	/* base case */
	if(n == 48){      /* N1-Hybrid2 is derived from N1-Hybrid by modifying this base value from n=3 to n=48 */
...
/* The N1-Hybrid2 Algorithm corresponds to n1_real() function. See the paper: https://eprint.iacr.org/2020/1336.pdf  for the details*/
