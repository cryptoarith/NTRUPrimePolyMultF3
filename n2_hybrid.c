...
void n2_complex(struct complex a[], struct complex b[], struct complex c[], int n){

	#define N2_COMPLEX_MAX_AB_SIZE 48 // n/4
	#define N2_COMPLEX_MAX_P_SIZE 95 // 2*n/4-1
	...
	struct complex ra1[N2_COMPLEX_MAX_AB_SIZE];
	struct complex ra2[N2_COMPLEX_MAX_AB_SIZE];
	struct complex ra3[N2_COMPLEX_MAX_AB_SIZE];
	struct complex ra4[N2_COMPLEX_MAX_AB_SIZE];
	struct complex ra5[N2_COMPLEX_MAX_AB_SIZE];
	struct complex ra6[N2_COMPLEX_MAX_AB_SIZE];
	struct complex ra7[N2_COMPLEX_MAX_AB_SIZE];
	struct complex ra8[N2_COMPLEX_MAX_AB_SIZE];
	struct complex ra9[N2_COMPLEX_MAX_AB_SIZE];
	struct complex ra10[N2_COMPLEX_MAX_AB_SIZE];
	struct complex ra11[N2_COMPLEX_MAX_AB_SIZE];
	struct complex ra12[N2_COMPLEX_MAX_AB_SIZE];

	struct complex rb1[N2_COMPLEX_MAX_AB_SIZE];
	struct complex rb2[N2_COMPLEX_MAX_AB_SIZE];
	struct complex rb3[N2_COMPLEX_MAX_AB_SIZE];
	struct complex rb4[N2_COMPLEX_MAX_AB_SIZE];
	struct complex rb5[N2_COMPLEX_MAX_AB_SIZE];
	struct complex rb6[N2_COMPLEX_MAX_AB_SIZE];
	struct complex rb7[N2_COMPLEX_MAX_AB_SIZE];
	struct complex rb8[N2_COMPLEX_MAX_AB_SIZE];
	struct complex rb9[N2_COMPLEX_MAX_AB_SIZE];
	struct complex rb10[N2_COMPLEX_MAX_AB_SIZE];
	struct complex rb11[N2_COMPLEX_MAX_AB_SIZE];
	struct complex rb12[N2_COMPLEX_MAX_AB_SIZE];
	...
	struct complex p0[N2_COMPLEX_MAX_P_SIZE];
	struct complex p1[N2_COMPLEX_MAX_P_SIZE];
	struct complex p2[N2_COMPLEX_MAX_P_SIZE];
	struct complex p3[N2_COMPLEX_MAX_P_SIZE];
	struct complex p4[N2_COMPLEX_MAX_P_SIZE];
	struct complex p5[N2_COMPLEX_MAX_P_SIZE];
	struct complex p6[N2_COMPLEX_MAX_P_SIZE];
	memset(p0, 0, sizeof(p0));
	memset(p1, 0, sizeof(p1));
	memset(p2, 0, sizeof(p2));
	memset(p3, 0, sizeof(p3));
	...
	n2_complex(a0, b0, p0, n4);
	n2_complex(ra3, rb3, p1, n4);
	n2_complex(ra9, rb9, p2, n4);
	n2_complex(ra11, rb11, p3, n4);	
	n2_complex(ra10, rb10, p4, n4);
	n2_complex(ra12, rb12, p5, n4);
	n2_complex(a3, b3, p6, n4);

	struct complex u1[N2_COMPLEX_MAX_P_SIZE];
	struct complex u2[N2_COMPLEX_MAX_P_SIZE];
	struct complex u3[N2_COMPLEX_MAX_P_SIZE];
	struct complex u4[N2_COMPLEX_MAX_P_SIZE];
	struct complex u5[N2_COMPLEX_MAX_P_SIZE];
	struct complex u6[N2_COMPLEX_MAX_P_SIZE];
	struct complex u7[N2_COMPLEX_MAX_P_SIZE];
	struct complex u8[N2_COMPLEX_MAX_P_SIZE];
	struct complex u9[N2_COMPLEX_MAX_P_SIZE];
	struct complex u10[N2_COMPLEX_MAX_P_SIZE];
	struct complex u11[N2_COMPLEX_MAX_P_SIZE];
	struct complex u12[N2_COMPLEX_MAX_P_SIZE];
	struct complex u13[N2_COMPLEX_MAX_P_SIZE];
	...
	struct complex c1[N2_COMPLEX_MAX_P_SIZE];
	struct complex c2[N2_COMPLEX_MAX_P_SIZE];
	struct complex c3[N2_COMPLEX_MAX_P_SIZE];
	struct complex c4[N2_COMPLEX_MAX_P_SIZE];
	struct complex c5[N2_COMPLEX_MAX_P_SIZE];
...
/* The N2-Hybrid Algorithm corresponds to n2_real() function. See the paper: https://eprint.iacr.org/2020/1336.pdf  for the details*/

void n2_real(struct complex a[], struct complex b[], struct complex c[], int n){

	#define N2_REAL_MAX_AB_SIZE 192 // n/4
	#define N2_REAL_MAX_P_SIZE 383 // 2*n/4-1
	...
	struct complex ra1[N2_REAL_MAX_AB_SIZE];
	struct complex ra2[N2_REAL_MAX_AB_SIZE];
	struct complex ra3[N2_REAL_MAX_AB_SIZE];
	struct complex ra4[N2_REAL_MAX_AB_SIZE];
	struct complex ra5[N2_REAL_MAX_AB_SIZE];
	struct complex ra6[N2_REAL_MAX_AB_SIZE];
	struct complex ra7[N2_REAL_MAX_AB_SIZE];
	struct complex ra8[N2_REAL_MAX_AB_SIZE];
	struct complex ra9[N2_REAL_MAX_AB_SIZE];
	struct complex ra10[N2_REAL_MAX_AB_SIZE];
	struct complex ra11[N2_REAL_MAX_AB_SIZE];
	struct complex ra12[N2_REAL_MAX_AB_SIZE];

	struct complex rb1[N2_REAL_MAX_AB_SIZE];
	struct complex rb2[N2_REAL_MAX_AB_SIZE];
	struct complex rb3[N2_REAL_MAX_AB_SIZE];
	struct complex rb4[N2_REAL_MAX_AB_SIZE];
	struct complex rb5[N2_REAL_MAX_AB_SIZE];
	struct complex rb6[N2_REAL_MAX_AB_SIZE];
	struct complex rb7[N2_REAL_MAX_AB_SIZE];
	struct complex rb8[N2_REAL_MAX_AB_SIZE];
	struct complex rb9[N2_REAL_MAX_AB_SIZE];
	struct complex rb10[N2_REAL_MAX_AB_SIZE];
	struct complex rb11[N2_REAL_MAX_AB_SIZE];
	struct complex rb12[N2_REAL_MAX_AB_SIZE];
	...
	struct complex p0[N2_REAL_MAX_P_SIZE];
	struct complex p1[N2_REAL_MAX_P_SIZE];
	struct complex p2[N2_REAL_MAX_P_SIZE];
	struct complex p3[N2_REAL_MAX_P_SIZE];
	struct complex p4[N2_REAL_MAX_P_SIZE];
	struct complex p5[N2_REAL_MAX_P_SIZE];
	struct complex p6[N2_REAL_MAX_P_SIZE];
	memset(p0, 0, sizeof(p0));
	memset(p1, 0, sizeof(p1));
	memset(p2, 0, sizeof(p2));
	memset(p3, 0, sizeof(p3));
	...
	ka2_real(a0, b0, p0, n4);
	ka2_real(ra3, rb3, p1, n4);
	n2_complex(ra9, rb9, p2, n4);
	...
	struct complex u1[N2_REAL_MAX_P_SIZE];
	struct complex u2[N2_REAL_MAX_P_SIZE];
	struct complex u3[N2_REAL_MAX_P_SIZE];
	struct complex u4[N2_REAL_MAX_P_SIZE];
	struct complex u5[N2_REAL_MAX_P_SIZE];
	struct complex u6[N2_REAL_MAX_P_SIZE];
	struct complex u7[N2_REAL_MAX_P_SIZE];
	struct complex u8[N2_REAL_MAX_P_SIZE];
	struct complex u9[N2_REAL_MAX_P_SIZE];

	sum_real(p0, p1, u1, p_size);
	sum_real(p2, p4, u2, p_size);
	sum_im_im_real(p2, p4, u3, p_size);
	difference_real(p2, p4, u4, p_size);
	sum_im_neg_im_real(p2, p4, u5, p_size);
	difference_real(u2, u1, u6, p_size);
	difference_real(u6, p6, u7, p_size);
	difference_real(u3, u1, u8, p_size);
	difference_real(u8, p4, u9, p_size);

	struct complex c1[N2_REAL_MAX_P_SIZE];
	struct complex c2[N2_REAL_MAX_P_SIZE];
	struct complex c3[N2_REAL_MAX_P_SIZE];
	struct complex c4[N2_REAL_MAX_P_SIZE];
	struct complex c5[N2_REAL_MAX_P_SIZE];

	struct complex *c0 = p0;

	sum_re_neg_im_real(u7, p2, c1, p_size);
	sum_real(u3, p6, c2, p_size);
	difference_real(u4, u5, c3, p_size);
	sum_real(u2, p0, c4, p_size);
	difference_real(u9, p6, c5, p_size);
...
int main(){
    ...
    /*write on c_n2_hybrid file*/
	FILE *outFile;
    outFile = fopen("c_n2_hybrid", "w");
    if (outFile == NULL)
	{
